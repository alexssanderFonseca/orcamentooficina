...
class AprovarOrcamentoUseCaseImplTest {
    ...
    @Mock
    private OrcamentoWebhookPort orcamentoWebhookPort; // New mock
    ...
    void deveAprovarOrcamentoComSucesso() {
        ...
        verify(orcamentoWebhookPort, times(1)).enviarAprovacao(orcamento.getId(), orcamento.getOrdemServicoId());
    }
